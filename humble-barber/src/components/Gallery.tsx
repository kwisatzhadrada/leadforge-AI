...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="py-24">
      <div className="wrap">
        <div ref={headRef}>
          <SectionHead
            ...
            title={
              <>
                Real Work, <span className="signal-text">Real Shop</span>
              </>
            }
      ...
      <div
        className={`fixed inset-0 z-[200] flex items-center justify-center bg-[rgba(3,4,6,0.94)] p-6 transition-opacity duration-300 ${
