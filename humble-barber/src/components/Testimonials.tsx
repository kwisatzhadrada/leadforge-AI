...
export function Testimonials() {
  ...
  return (
    <section id="reviews" className="py-24 bg-[var(--ink-elevated)]">
      <div className="wrap">
        <div ref={headRef}>
          <SectionHead
            center
            ...
            title={
              <>
                What The <span className="signal-text">Chair</span> Says
              </>
            }
          />
        </div>
  ...
  return (
    <div ref={ref} className="rounded-[22px] border border-[var(--border-soft)] bg-[var(--surface)] p-8">
      ...
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[var(--border)] bg-[linear-gradient(135deg,var(--surface-2),var(--ink-elevated))] font-mono text-[0.9rem]">
          {t.name.charAt(0)}
        </div>
        <div>
