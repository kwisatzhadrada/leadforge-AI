...
PLAN_DISPLAY = [
    ...
    },
    {
        ...
        "interval": "month",
        "reports_per_month": 5,
        "features": ["5 growth packages/month", "All 5 modules", "PDF export", "Email support"],
        "highlight": False,
    ...
    },
    {
        ...
        "features": ["25 growth packages/month", "Priority generation", "PDF export", "Priority support"],
        "highlight": True,
